...
# or
nano ~/Library/Application\ Support/Claude/claude_desktop_config.json     # Opens with nano in terminal
```
...
Replace both `/path/to/tavily-mcp/build/index.js` with the actual path to your installation and `your-api-key-here` with your actual Tavily API key.
